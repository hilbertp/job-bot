# Philipp Hilbert. *Diplomatic Product Leadership · AI Products, Discovery and Squad Leadership.*
...
Unknown territory requires quick, inexpensive discovery bets that resolve the largest uncertainty first. Cheap experiments make expensive decisions safe(r). This is also what makes me useful across client organisations rather than only inside one: the method travels, the domain is learned on arrival.
...
- Led a cross-functional squad of architects, data scientists, backend and frontend engineers and QA, across several countries
