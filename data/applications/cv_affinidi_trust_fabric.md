# Philipp Hilbert - *Senior Product Manager (Technical) · Agent Infrastructure, Identity and Governance*
...
10+ years of XP · based in Berlin and Limassol · agent systems, digital identity, regulated platforms · German native, English C2 · available at short notice

---

## Trust, identity and agent infrastructure

- **I operate what Trust Fabric governs.** I built and run a multi-agent framework in which coordinator, implementer and evaluator agents work a shared queue under guardrails I designed, and when quality drifts I read the traces myself. Verifiable agent identity, policy guardrails and real-time observability are not abstractions to me; they are the three things I wish I could have bought instead of built.
- **Identity from the inside.** Co-founded Qcrypt, quantum-secure encryption shipped to enterprise customers across a three-layer hardware and software architecture. Product Owner at Bundesdruckerei for national health data platforms: secure data structures and identity management under the highest privacy requirements.
- **Provenance and governance in production.** At Rohde & Schwarz I owned reproducible pipelines with complete provenance and audit trails for safety-critical AI use. Twice deputy IT security officer, with compliance, governance and data lineage under a recurring audit cycle.
- **APIs, systems and integrations, hands-on history.** Product Owner of the integration team at Scheidt & Bachmann; catalogue and API integration into legacy systems at AOK ITSCare for roughly 20,000 users; at CLINET I implemented the interface into the incumbent system landscape myself, which still gives me a realistic sense of what an integration truly costs.
- **Developer-obsessed by necessity.** The consumers of my R&S platform were other teams and external developers. We shipped a second, code-heavy workflow next to the intended one and measured which got used: the intended one received exactly zero clicks. Adoption was the only honest metric, and I have the scar tissue to prove it.
...
- AI assistance across the full funnel, from interview through selection and vetting, so one person can run the entire day-to-day operation
- End-to-end user journey across all three sides: contractors, workers and internal operations
...
- Reproducible pipelines with complete provenance and audit trails for safety-critical use
...
Secure data structures and identity management for national health programmes, under the highest privacy requirements.

### Scheidt & Bachmann · Product Owner, Integration Team
*2020 to 2021 · Mönchengladbach*

- Product Owner of the integration team: turning research outcomes into productive, releasable integration across site and head-office systems
...
- **Kvitt Payment Solutions · Founder and CFO (2013 to 2018).** Mobile payments platform built from zero: payment service provider integration, settlement flows, onboarding, full user experience. Acquired and operated by Sparkasse.
