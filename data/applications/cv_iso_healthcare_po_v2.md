...
- **Project Phoenix · Projektleitung, Quantitative Research (2026–heute):** End-to-end-Forschungsplattform zur systematischen Überprüfung von Handelsstrategien über 20+ Instrumente (Krypto, Edelmetalle, Aktien, Energie), mit einer aus der klinischen Forschung entlehnten Prä-Registrierungs-Disziplin: jede Hypothese wird vor der Berechnung mit Parametern, Hürden und Kontrollen in Git registriert; Ergebnisse landen manipulationssicher in einem Append-only-Ledger
  - Backtesting-Engine gegen menschliches Urteil validiert: 100% Übereinstimmung über 100+ handbewertete Setups, jeder Disput auf den Rohdaten adjudiziert und als Regressions-Fixture eingefroren; eigenes Human-in-the-Loop-Labeling-Tooling mit ~150 gelabelten Setups als Ground Truth
  - Multi-Agent-AI-Forschung mit adversarialer Verifikation: parallele Agenten implementieren Experimente unabhängig, Ergebnisse müssen bis auf die Einheit reproduzieren; drei selbst aufgedeckte Fehlerklassen (u. a. Lookahead) im Register dokumentiert
  - Ergebnisehrlichkeit als Prinzip: die untersuchte Strategie-Familie über ~300 Konfigurationen mit Positiv-Kontrollen falsifiziert (belastbares Negativergebnis); statistische Inferenz unter Korrelation und multiplen Vergleichen methodisch sauber korrigiert
