...
|---|---|---|---|---|---|
| Bewerbung_Philipp_Hilbert_Deel_Equity_PM.pdf (+ CV solo, **2 Seiten, neues Format**) | cl/cv_deel_equity_pm.md | EN | Senior PM Equity, Deel, EMEA remote. Score von 78 auf **base 90 / tailored 94 KORRIGIERT**: die alte Bewertung nannte Equity "soft gap", falsch. Philipp bestaetigt "sehr vertraut mit equity deals als gruender" (3 Firmen, eine AG, 8y CFO: Runden, Dilution, Gruender-/Investorenvertraege) + in_vis VSOP-Design + haelt selbst VSOP. JD listet Stock-Admin-Plattformen nur als nice-to-have. CL nennt die echte Grenze offen ("rather be precise than impressive"). FLAGS: 80-120k USD ~74-111k EUR, ueber neuem 70k-Floor aber unter 125k-Ziel; Deel nutzt AEDT/KI-Screening | 80-120k USD | 2026-08-09 |
| Bewerbung_Philipp_Hilbert_FxPro_Payments_PM.pdf (+ CV solo) | cl/cv_fxpro_payments_pm.md (vom Problem-First-Master) | EN | Senior PM Payments Platform, FxPro (Forex-Broker, 600+ MA), **Ypsonas = 10 min von Zuhause, Shuttle ab Limassol, 4. Heimat-Treffer**. Kern: Kvitt = Payments gegruendet/PSP/Settlement/an Sparkasse verkauft; 8y CFO bepreist Approval-Rates in Marge; Orchestrierung/Routing/Cascading als Allokationsmathematik gerahmt (Merit-Order, Regelenergie); Broker-Scale-Orchestrierungs-Gap EHRLICH benannt. Base 88 / tailored 94. FLAGS: kein Gehalt genannt; On-site; 3-stufige Interview-Kette | none stated | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_BnBerry_Technical_PM.pdf (+ CV solo) | cl/cv_bnberry_technical_pm.md (vom Problem-First-Master) | EN | Senior Technical PM, BnBerry (Hospitality-Tech, Hotels->OTA), Zypern. Gebaut NACH Floor-Senkung auf 70k (Band 50-80k USD ~46-74k EUR, Topend verhandeln!). Kopfabschnitt "Keeping an integration platform healthy is a product job": Bestandsplattform-Stewardship (EMIL), Production-Forensik mit eigenen Haenden, Debt quantifiziert (R&S Deploy-Zeiten), CFO-Blick auf Churn/Support-Last; Hospitality-Gap ehrlich benannt. Base 87 / tailored 93 | 50-80k USD | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_FundraiseUp_New_Products.pdf (+ CV solo) | cl/cv_fundraiseup_new_products.md (vom Problem-First-Master) | EN | Senior PM New Products, Fundraise Up, **Zypern remote = Wohnort**. JD spiegelt seine Doktrin woertlich: Investment-Thesen, Kill-Kriterien, dokumentierte tote Ideen, PM-gebaute AI-Prototypen; Revenue-Model-Ownership = 8y CFO; Founder = benanntes Nice-to-have, daher BEWUSSTE ABWEICHUNG von der construct8-nicht-mein-Venture-Regel (CL: "with my own money on the line, three times", 399-EUR-Fee-Test). Base 91 / tailored 96. FLAG: Band 5.9-6.5k/Mo unter Floor, Ausnahme fuer diesen AG am 14.07 genehmigt (Checkout-PO-Praezedenz) | 5.9-6.5k EUR/Mo | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_Kraken_Consumer_PM.pdf (+ CV solo) | cl/cv_kraken_consumer_pm.md (vom Problem-First-Master) | EN | Senior PM Consumer Trading, Kraken, **Zypern = Wohnort, location 100** (3. Heimat-Treffer). JD verlangt woertlich Claude-Code-Prototyping (= sein Alltag; CL: "I will not describe it, I will share my screen") und crypto OR trading OR banking; er hat ALLE DREI (8y Trading auch auf Kraken, 2 Crypto-Zyklen, Kvitt/Sparkasse + 8y CFO). Base 90 / tailored 96, staerkster Fit des Zypern-Trios. FLAGS: kein Gehalt; "4+ years" koennte Mid-Level-Band bedeuten, frueh klaeren; Arbeitsmodell (Office/Hybrid) unklar | none stated (floor 125k) | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_Criteo_BidSwitch.pdf (+ CV solo) | cl/cv_criteo_bidswitch_pm.md (vom Problem-First-Master) | EN | Senior PM BidSwitch (r20871), Criteo, **Limassol hybrid = Wohnort, location 100** (2. Heimat-Treffer nach TradingView). Kopfabschnitt "Why infrastructure between parties is my home ground": construct8 als Two-Sided-Routing, RTB=Auktionsmarkt-Bruecke (8y Trading, Merit-Order, Regelenergie-Pipeline), S&B Spec-to-Model. CL nennt den Ad-Tech-Gap EXPLIZIT statt ihn zu verstecken; "not a software engineer" nach kanonischer Positionierung. Base 85 / tailored 92. FLAGS: kein Gehalt genannt; Workday-Portal Upload-Felder pruefen | none stated (floor 125k) | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_Affinidi_Trust_Fabric.pdf (+ CV solo) | cl/cv_affinidi_trust_fabric.md (vom Problem-First-Master) | EN | Senior PM (Technical) Trust Fabric, Berlin hybrid. Kernthese: er BETREIBT was Trust Fabric verkauft (Multi-Agent-Framework, Guardrails, Traces); Qcrypt + Bundesdruckerei = Identity-Nice-to-have; R&S Provenance + 2x stellv. IT-Sicherheitsbeauftragter = Governance; Zero-Clicks = developer-obsessed. Base 88 / tailored 95. Ersetzt das Auto-Paket vom selben Tag (Em-Dash-Verstoss, alter Aufbau). 5 DB-Zeilen -> 1 Kanal (linkedin_83c14d4cc9e7901c). Anzeige seit Juni mehrfach neu gepostet = Stelle offenbar schwer zu besetzen | none stated (floor 125k) | 2026-08-08 |
| Bewerbung_Philipp_Hilbert_TradingView_Senior_PM.pdf (+ CV solo: CV_Philipp_Hilbert_TradingView_Senior_PM.pdf) | cl/cv_tradingview_senior_pm.md (vom Problem-First-Master) | EN | Senior PM TradingView, **Limassol hybrid = Wohnort, location 100**. Kopfabschnitt "Markets, traders and products at scale": 8y Trading + phoenix882, Siemens-Merit-Order-Story, Kvitt/Sparkasse, R&S-Zero-Clicks als A/B-Beleg, Discovery-Trio fuer UX-Anforderung. CL endet mit "in your office the same day". Base 88 / tailored 94. FLAGS: kein Gehalt genannt (nur Bonus + Premium), Band frueh klaeren; Scale-Gap (zig Mio Nutzer) nicht wegdiskutiert sondern mit Craft-Belegen beantwortet | none stated (floor 125k) | 2026-07-31 |
| Bewerbung_Philipp_Hilbert_EWERK_Product_Owner.pdf | cl_ewerk_po.md + cv_ewerk_po.md | DE | PO (m/w/d) EWERK Group, Stuttgart hybrid, an Anika Buschette (anika.buschette@ewerk.com), Bewerbung über factorialhr. **Erstes deutsches Problem-First-Paket.** CV-Kopfabschnitt "Technische Tiefe und Systemintegration" beantwortet ihre Anforderungsliste in ihrer Reihenfolge; nur Angular als NICHT produktiv verantwortet benannt (Anzeige sagt selbst "Kein Match bei jedem einzelnen Punkt? Muss auch nicht sein"). Django ist AUSDRÜCKLICH als produktiv aus der BA-Verwaltungsumgebung ausgewiesen; erste Fassung behauptete faelschlich das Gegenteil, korrigiert 2026-07-31, siehe Regel in PROFILE.md. Anschreiben startet mit ihren eigenen Worten (Empathie, Besonnenheit, technischer Pragmatismus), R&S-Zero-Clicks als Discovery-Beleg, Umzug nach Stuttgart und fehlendes Informatikstudium selbst angesprochen. Base 85 / tailored 93. FLAGS: Umzug Stuttgart ist echte Zusage; kein Gehalt genannt | keine Angabe; Untergrenze 125k intern | 2026-07-30 |
| (nicht gebaut) | keine | DE | SoftProject GmbH, PO Ettlingen (X4 BPMS Low-Code). Fachlich 88, ABER Gehaltsspanne 70.000-77.000 EUR = 56-62% der 125k-Untergrenze, plus geforderte Zeugnisse. Discard nach derselben Rechnung wie Unit4. 3 DB-Zeilen auf discarded | 70.000-77.000 EUR p.a. | 2026-07-30 |
| CV_Philipp_Hilbert_AgilityPR_Product_Owner.pdf | cv_agilitypr_product_owner.md (from cv_general_problem_first.md) + email intro in chat | EN | PO agentic workflows, Agility PR Solutions (Ottawa, fully remote), careers@agilitypr.com. Leading section "Agentic workflows and AI-driven applications"; R&S multimodal-to-dataset pipeline used as the bridge to media monitoring / newswire ingest; header states a daily 09:00-14:00 ET overlap. Base 87 / tailored 93. **COMP BLOCKER: band is 90-120k CAD ≈ 57-76k EUR, far under floor.** Residency likely Canada-only (RRSP, Canadian benefits); email asks directly. Already applied 2026-05-11, no response; email says so openly | none countered; their band 90-120k CAD | 2026-07-30 |
| CV_Philipp_Hilbert_Scalable_AI_Platform.pdf | cv_scalable_ai_platform.md (from cv_general_problem_first.md) | EN | PM AI Platform, Scalable Capital. Problem-first master CV + leading section "AI platform, agents and governance"; R&S reframed as "internal platform whose consumers were other teams"; Web3/crypto section deliberately KEPT (Scalable trades crypto). Base 90 / tailored 96, strongest permanent fit since Helsing. **NOT SUBMITTED: abandoned at the portal upload step, which demands a degree certificate (Urkunde) he does not own.** Second confirmation of that blocker at Scalable. Reuse the CV, not the employer | none stated (floor 125k) | 2026-07-30 |
...
| application_iso_healthcare_proxy_po.pdf | cl/cv_iso_healthcare_po.md | DE | Digital-anamnesis exact match (CLINET, CGM implemented, anonymized-data offers); literal Proxy-PO title; ISO Recruiting, Projekt 3009610, Leona Günther. **SUBMITTED** (confirmed 2026-07-31). End client BG prevent GmbH. Headhunter intel: they already replaced TWO people in a row on this mandate (internal PO, then the external replacing them) over the arrogance of the Ober- and Chefärzte, so temperament is the real selection criterion and CLINET is the proof. Do NOT re-quote above 80 without a scope change. Story in STORIES_AND_VOICE.md | 80 EUR/h all-in; avail 01.08.26 | 2026-06-11 |
