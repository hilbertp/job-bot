...
|---|---|---|---|---|---|
| Bewerbung_Philipp_Hilbert_Proxy_Product_Owner.pdf | cl/cv_iso_healthcare_po_v2.md | DE | RE-LISTING of Projekt 3009610 as 3028163 (internal hire fell through); recruiter Tomasz Login re-approached proactively 2026-07-28 after phone attempt; **ENDKUNDE (von Philipp 2026-07-28): BG prevent GmbH, bg-prevent.de** (bis 07/2025 B·A·D Gesundheitsvorsorge und Sicherheitstechnik), Sitz Bonn-Beuel = die 5% Praesenz; 3.500+ MA davon 800+ Betriebsaerzte, ~150 Gesundheitszentren, 210.000+ betreute Unternehmen -> "mehrere Millionen Nutzer" = deren Beschaeftigte, "Anamneseprozesse" = Anamnese vor arbeitsmedizinischer Vorsorge, "mehrere fachliche Bereiche" = Arbeitsmedizin / Arbeitssicherheit / BGM / Reise- und Verkehrsmedizin / Strahlenschutz. Domain Owner sind Aerzte -> Diplomatie-Absatz sitzt genau richtig. Kunde im CL bewusst NICHT namentlich genannt (Agentur nicht verunsichern), stattdessen Domaenensprache; v2 adds nice-to-have coverage (DDD/Greenfield/Architekt), asap availability + Denorios/construct8/Phoenix entries; CV rebalanced via 3-draft/3-judge workflow (recruiter-skim spine) + S&B SAFe interim station; CL enthält Diplomatie-Absatz (Ober-/Chefärzte bei CLINET) weil beim Endkunden bereits mehrere Rollen ZWISCHENMENSCHLICH gescheitert sind (1 intern, 1 extern, beide schnell ausgetauscht) - das ist der eigentliche Entscheidungsfaktor dieses Mandats; scored 82/96 (DB id freelancermap_9f7ddc2c0e2d8063) | 80 EUR/h all-in; avail asap | 2026-07-28 |
